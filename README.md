...
非特定視聴データを題材に、データの取り込みからデータ変換、セマンティックレイヤー、AI エージェント、可視化アプリまでを Snowflake の中だけで一本通すハンズオン教材です。所要時間は約 2 時間 35 分で、Snowsight のブラウザ画面だけで完結します。ローカルへのツールのインストールやコマンドライン操作は必要ありません。
